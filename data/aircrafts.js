const aircraftData = [
    ...
    },
    {
        ...
        description: "A321에 신형 엔진을 적용하여 효율성을 극대화한 기종입니다. 기존 단거리 대량수송 여객기로서의 한계를 넘어, 항속거리를 대폭 늘린 A321LR 및 A321XLR 등의 파생형을 통해 대서양 횡단 및 대륙 간 장거리 노선까지 취항할 수 있는 핵심 중장거리 소형 여객기로 발돋움했습니다.",
    ...
    // 707 Family (그룹 카드)
    {
        ...
        description: "상업용 제트 여객기 시대를 본격적으로 개척한 보잉의 역사적인 4발 제트기입니다. 전 세계 민항기 여행의 대중화를 이끌었으며 현대 여객기의 기본 설계를 완성한 기념비적 모델입니다. 기존 프로펠러 여객기 대비 비행시간을 절반 수준으로 단축시키며 보잉을 세계 최고의 여객기 제조사로 도약시킨 주역입니다. 이때 정립된 3-3 배열 동체 폭 규격은 훗날 보잉 727, 737, 757까지 고스란히 계승되었으며, 높은 신뢰성의 프레임을 바탕으로 공중급유기 및 조기경보기 등 군용 특수기로도 폭넓게 개조되었고, 지금까지도 사용되고 있습니다.",
    ...
    // 4. 737 MAX (그룹 카드)
    {
        ...
        description: "최신 CFMI LEAP-1B 엔진과 독특한 분할형 윙렛(Split-Scimitar Winglet)을 장착하여 연비 효율을 극대화한 4세대 737 시리즈입니다. 뛰어난 항속거리로 장거리 단거리 노선을 동시 커버합니다. 다만 1세대 737 오리지널의 오랜 기본 설계를 큰 변화 없이 무리하게 개량하는 과정에서 발생한 조종 계통 소프트웨어(MCAS) 결함으로 인해 연이은 대형 참사가 발생했으며, 이로 인해 전 세계에서 전면적인 장기 비행 중단(Grounding) 사태를 겪은 비운의 역사도 가지고 있습니다.",
