const aircraftData = [
    ...
    // A330 Family (그룹 카드)
    {
        ...
        description: "에어버스의 중장거리 대표 쌍발 광동체 여객기입니다. 높은 신뢰성과 뛰어난 경제성 덕분에 전 세계 대형 항공사들의 장거리 노선 주력 항공기로 오랫동안 사랑받고 있습니다.",
    ...
    // A340 Family (그룹 카드) — 신규 추가
    {
        ...
        description: "안정성을 극대화하기 위해 4발 엔진을 채택한 중장거리 여객기입니다. 쌍발기의 ETOPS 규제가 완화되기 전까지 초장거리 노선과 해양 비행의 최강자로 군림했던 기종입니다.",
    ...
    // 1. 737 Original (그룹 카드)
    {
        ...
        description: "현재 전 세계 협동체 시장의 양대 산맥인 보잉 737 시리즈의 시초가 된 기종입니다. 엔진이 날개 밑에 매우 가깝게 장착된 특유의 낮은 지상고 디자인이 특징입니다.",
